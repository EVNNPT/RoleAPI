...
public class DashboardServices : IDashboardServices
{
    ...
    public async Task<List<SoLuongTBModel>> GetSoLuongTB()
    {
        ...
        var sldd = _context.NvDuongdays.Count();
    ...
    public async Task<List<SLTBDongCatModel>> GetSLTBDongCat()
    {
        ...
        var slddd = _context.NvDuongdays.Where(it => it.Tthientai == "Đóng").Count();
        var slddc = _context.NvDuongdays.Where(it => it.Tthientai == "Cắt").Count();
